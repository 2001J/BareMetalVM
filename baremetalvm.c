...
// //added this own memcpy function
// static inline void copy(unsigned char* dest, const unsigned char* src, size_t n) {
//     while (n--) {
//         *dest++ = *src++;
//     }
// }
...
// //added this own printhex function
// static void printhex(const unsigned char* data, size_t len, char delimiter) {
//     for (size_t i = 0; i < len; i++) {
//         printf("%02x%c", data[i], delimiter);
//     }
//     printf("\n");
// }
